...
This project includes a polish pass focused on premium Material 3 UI, smoother opening/navigation behavior, and scalable scrolling. See `UI_PERFORMANCE_UPGRADE.md` for exact changes.
