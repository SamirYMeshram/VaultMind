...
class DefaultActivityRepository @Inject constructor(private val dao: RecentActivityDao, @IoDispatcher private val dispatcher: CoroutineDispatcher) : ActivityRepository {
...
class DefaultBackupRepository @Inject constructor(private val backupDao: BackupDao, private val activityRepository: ActivityRepository, @IoDispatcher private val dispatcher: CoroutineDispatcher) : BackupRepository {
